...
\end{problem}
\begin{problem}{7}
Chong’s Airport Taxi brought five passengers to the airport yesterday, each leaving on a different flight.

Using the clues below, determine the passenger name, destination, and purpose for travel for each of the departure times.

\begin{enumerate}[label=\Roman*.]
      \item The five people are Jiwu, Anders, the person visiting family, the person going to Tokyo, and the person leaving at 5:15 p.m.
      \item Minjoo left one hour after the person going to Seoul, who was travelling for school.
      \item Jion left at 1:15 p.m. and was going on vacation. She was not the person going to Vladivostok.
      \item Dom and Jiwu were two of the passengers. Only one of them went to Banpo.
      \item Two people were traveling for business. They left five hours apart and went to Banpo and Suji, in some order.
      \item The departure times are 12:15 pm, 1:15 pm, 4:15 pm, 5:15 pm, and 6:15 pm in some order.
\end{enumerate}
Make a table with the passenger name, destination, and purpose for travel for each of the given departure times.
\end{problem}
\end{document}
